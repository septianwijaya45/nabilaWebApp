            ...
            <form action="{{ route('setting.update') }}" method="post" class="form-setting" data-toggle="validator" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group row">
                        <label for="nama_perusahaan" class="col-lg-2 control-label">Nama Instansi</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="path_logo" class="col-lg-2 control-label">Logo Instansi</label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group row">
                        <label for="path_kartu_member" class="col-lg-2 control-label">Kartu Identitas</label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group row">
                        <label for="diskon" class="col-lg-2 control-label">Survey yang ke</label>
                        <div class="col-lg-2">
                    ...
                    <div class="form-group row">
                        <label for="tipe_nota" class="col-lg-2 control-label">Jenis Survey</label>
                        <div class="col-lg-2">
                            <select name="tipe_nota" class="form-control" id="tipe_nota" required>
                                <option value="1">Survey Nasional</option>
                                <option value="2">Survey Daerah</option>
                            </select>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
